...
import { ArrowRight, ClipboardCheck, ShieldCheck, WifiOff } from "lucide-react";
  ...
  return (
    <section className="relative mb-6 overflow-hidden rounded-2xl border border-radar/25 bg-gradient-to-r from-radar/10 via-white to-cyan-50 p-4 shadow-sm dark:via-midnight-light dark:to-cyan-950/10 sm:p-5">
      ...
      <div className="relative flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
        ...
        <Link href="/action-center" className="inline-flex min-h-11 shrink-0 items-center justify-center gap-2 rounded-xl bg-radar px-5 text-sm font-bold text-white shadow-sm transition hover:-translate-y-0.5 hover:shadow-lg">Open Action OS <ArrowRight className="h-4 w-4" /></Link>
      </div>
    </section>
  );
}
