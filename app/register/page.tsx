...
import { ArrowLeft, Building2, Heart, Loader2, Sprout, UserPlus } from "lucide-react";
      ...
      <div className="grid min-h-screen lg:grid-cols-[.95fr_1.05fr]">
        <section className="flex min-h-screen items-center justify-center p-4 sm:p-8 lg:p-12">
          <div className="w-full max-w-md">
            <div className="mb-6 flex items-center justify-between"><BrandLockup href="/" /><Link href="/login" className="flex items-center gap-1 text-xs font-bold text-slate-500">Already registered? Log in</Link></div>
