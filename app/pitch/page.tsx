...
import { ArrowLeft, ArrowRight, BarChart3, Building2, CheckCircle2, CircleDollarSign, Database, Globe2, Landmark, Play, Radio, Shield, Sprout, Users, Waves } from "lucide-react";
...
const sections = [
  ...
  { n: "02", title: "The missing layer is the decision system.", body: "NaijaClimaGuard is being built to connect forecast → exposure → economic loss → action → financing → delivery → verification." },
  { n: "03", title: "One platform, different human questions.", body: "A household asks whether home is safe. A farmer asks what happens to the farm. Government asks where to act first. An insurer asks what portfolio is exposed. The same intelligence layer can answer each at the right level." },
];
