...
import { FLOODPASS_PUBLIC_COPY } from "./pages/floodpass-public";
import { ACCOUNT_ENTRY_COPY } from "./pages/account-entry";
import { WORKSPACE_V2_COPY } from "./pages/workspace-v2";

const PAGE_PACKS = [FLOODPASS_PUBLIC_COPY, ACCOUNT_ENTRY_COPY, WORKSPACE_V2_COPY, REPORT_COPY, EVIDENCE_OUTLOOK_COPY, PROFILE_COMMAND_COPY, DASHBOARD_COPY, AUTH_COPY, TECHNICAL_COPY, NAVIGATION_GROWTH_COPY, REVENUE_COPY, PITCH_COPY];
