...
const en: ProductProofCopy = {
  ...
  investor: {
    ...
    readinessTitle: "TRL 6 demonstration-ready software. Controlled evidence gate.",
    readinessBody: "The integrated product, accounts, dashboard, action workflow and evidence controls are ready for a relevant-environment demonstration. A TRL 6 achievement claim unlocks only after that field demonstration is signed and reviewable.",
    ...
    fundingTitle: "How the ₦150m round is deployed",
    fundingBody: "Approximately US$95k at the planning exchange rate. The round funds a procurement-grade decision loop, field evidence and institutional adoption—not another generic flood map.",
    fundingLabels: ["Engineering and data infrastructure", "Ground-truth sensor pilot and validation", "Institutional sales and go-to-market", "Compliance, CAC and IP protection", "Working capital"],
    ...
    blockedList: ["TRL 6 achieved without a signed relevant-environment demonstration.", "Nationwide flood-prediction accuracy.", "Autonomous public warning authority.", "Verified avoided loss without customer outcome evidence."],
  },
  evidence: {
    ...
    status: "Software status: ready for the TRL 6 field demonstration",
    statusBody: "The system is integrated and deployable. The claim changes to TRL 6 achieved only when the relevant-environment demonstration and independent evidence review are complete.",
    ...
    blockedClaims: ["80% accuracy or 80% national accuracy.", "Prospectively validated public-warning performance.", "TRL 6 achieved before signed field evidence.", "Autonomous evacuation or warning authority."],
...
const pcm: ProductProofCopy = {
  ...
  investor: {
    ...
    readinessLabel: "Readiness position", readinessTitle: "Software ready for TRL 6 field demonstration. Evidence gate dey controlled.", readinessBody: "The complete product, account, dashboard, action workflow and evidence control ready for relevant-environment demonstration. TRL 6 achieved claim go open only after signed field proof.",
    ...
    fundingTitle: "How we go use the ₦150m round", fundingBody: "Na about US$95k for the planning exchange rate. The round go fund procurement-grade decision loop, field evidence and institutional adoption—not another ordinary flood map.", fundingLabels: ["Engineering and data infrastructure", "Ground-truth sensor pilot and validation", "Institutional sales and go-to-market", "Compliance, CAC and IP protection", "Working capital"], output: "Acceptance output",
    ...
    blockedList: ["TRL 6 achieved without signed relevant-environment demonstration.", "Nationwide flood-prediction accuracy.", "Autonomous public warning authority.", "Verified avoided loss without customer outcome evidence."],
  },
  evidence: {
    eyebrow: "Public evidence room", title: "Wetin dey work, where limit dey, and wetin come next.", lead: "This page separate the live public product from Riverine Watch v1 shadow model. E no turn repository check into field evidence.", status: "Software status: ready for TRL 6 field demonstration", statusBody: "The full system don integrate and e ready to deploy. We go call am TRL 6 achieved only after relevant-environment demonstration and independent review complete.",
    ...
    claimsTitle: "Claim ledger", claimsBody: "Every sales statement must stay inside this boundary until prospective and field evidence change am.", supported: "Supported", blocked: "Not supported", supportedClaims: ["4 of 5 eligible past events detected retrospectively for Lokoja and Makurdi.", "Frozen 14-day WATCH horizon and 0.70 WATCH threshold.", "Deterministic scoring of preserved operational-source bundle."], blockedClaims: ["80% accuracy or 80% national accuracy.", "Prospectively validated public-warning performance.", "TRL 6 achieved before signed field evidence.", "Autonomous evacuation or warning authority."],
...
ha.investor.readinessTitle = "Manhajar ta shirya don gwajin fili na TRL 6. Ana kula da ƙofar shaida.";
ha.investor.readinessBody = "Cikakken samfurin, asusu, dashboard, tsarin aiki da kulawar shaida sun shirya don gwaji a yanayin da ya dace. Za a ce an cimma TRL 6 ne bayan gwajin fili da bita mai zaman kanta.";
ha.investor.blockedList[0] = "TRL 6 achieved ba tare da sa hannun shaidar gwajin fili ba.";
ha.evidence.status = "Matsayin software: ta shirya don gwajin fili na TRL 6";
ha.evidence.statusBody = "An haɗa cikakken tsarin kuma yana shirye a tura. Za a ce an cimma TRL 6 ne bayan gwajin yanayi mai dacewa da bita mai zaman kanta.";
ha.evidence.blockedClaims[2] = "TRL 6 achieved kafin shaidar fili mai sa hannu.";

yo.investor.readinessTitle = "Software ti ṣetan fun àfihàn pápá TRL 6. A ń ṣakoso ààlà ẹ̀rí.";
yo.investor.readinessBody = "Ọjà, àkọọlẹ̀, dashboard, action workflow àti evidence control ti ṣetan fun àfihàn ní relevant environment. A ó pe e ní TRL 6 achieved lẹ́yìn field proof àti independent review.";
yo.investor.blockedList[0] = "TRL 6 achieved láìsí relevant-environment demonstration tí a fọwọ́ sí.";
yo.evidence.status = "Ipo software: ó ṣetan fún àfihàn pápá TRL 6";
yo.evidence.statusBody = "A ti so gbogbo eto pọ̀, ó sì ṣetan fun deployment. A ó pe e ní TRL 6 achieved lẹ́yìn relevant-environment demonstration àti independent review.";
yo.evidence.blockedClaims[2] = "TRL 6 achieved kí field evidence tí a fọwọ́ sí tó wà.";

ig.investor.readinessTitle = "Software dị njikere maka TRL 6 field demonstration. Claim gate nọ n'okpuru njikwa.";
ig.investor.readinessBody = "Product, accounts, dashboard, action workflow na evidence control dị njikere maka relevant-environment demonstration. A ga-akpọ ya TRL 6 achieved naanị mgbe field proof na independent review zuru ezu.";
ig.investor.blockedList[0] = "TRL 6 achieved na-enweghị signed relevant-environment demonstration.";
ig.evidence.status = "Software status: ready for TRL 6 field demonstration";
ig.evidence.statusBody = "E jikọtara system ahụ ma ọ dị njikere maka deployment. A ga-akpọ ya TRL 6 achieved naanị mgbe relevant-environment demonstration na independent review zuru ezu.";
ig.evidence.blockedClaims[2] = "TRL 6 achieved tupu signed field evidence.";
